...
const LIVE_TAB_COL_INDEX = {
  ...
  productionType: 9,  // I
  reworkType: 12,     // L
  tatStartDate: 25,   // Y — date picked for production
  cdName: 27,         // AA
  uploadDate: 76,     // BX
};
...
const ANALYTICS_LIVE_TAB_COL_INDEX = {
  ...
  assetLink: 75,       // BW
  uploadDate: 76,      // BX
  threeSecPlayPct: 81, // CC
  thruPlaysPct: 82,    // CD
  video0To25Pct: 83,   // CE
  video25To50Pct: 84,  // CF
  video50To75Pct: 85,  // CG
  video75To95Pct: 86,  // CH
  video0To95Pct: 87,   // CI
  thruPlayTo3sRatio: 88, // CJ
  absoluteCompletionPct: 89, // CK
  cpmUsd: 91,          // CM
  cpiUsd: 92,          // CN
  ctrPct: 93,          // CO
  amountSpentUsd: 94,  // CP
  outboundClicksToCompletionPct: 95, // CQ
  reach: 96,           // CR
  impressions: 97,     // CS
  clickToInstall: 98,  // CT
};
